...
!function(t, e, n, i) {
    ...
    function o(e, n, a) {
        ...
        n.sortToPreventGaps !== i && (n.sortByDimension = n.sortToPreventGaps,
        delete n.sortToPreventGaps),
        r.options = t.extend({}, t.fn.cubeportfolio.options, n, r.$obj.data("cbp-options")),
        r.isAnimating = !0,
        ...
        r.$obj.addClass("cbp"),
        (0 === s.length || s.first().hasClass("cbp-item")) && (r.wrapInner(r.obj, "cbp-wrapper"),
        r.addedWrapp = !0),
    ...
    t.extend(o.prototype, {
        ...
        wrapInner: function(t, e) {
            ...
            !(t.length && t.length < 1))
                ...
                a = t.length - 1; a >= 0; a--) {
                    for (o = t[a],
                    (r = n.createElement("div")).setAttribute("class", e); o.childNodes.length; )
            ...
            requestAnimationFrame(function() {
                var o = e.find("img").map(function(e, n) {
                    if (n.hasAttribute("width") && n.hasAttribute("height")) {
                        if (n.style.width = n.getAttribute("width") + "px",
                        n.style.height = n.getAttribute("height") + "px",
                        n.hasAttribute("data-cbp-src"))
                            return null;
                        if (null === i.checkSrc(n))
                            i.removeAttrImage(n);
                        else {
                            var o = t("<img>");
                            o.on("load.cbp error.cbp", function() {
                                t(this).off("load.cbp error.cbp"),
                                i.removeAttrImage(n)
                            }),
                            n.srcset ? (o.attr("sizes", n.sizes || "100vw"),
                            o.attr("srcset", n.srcset)) : o.attr("src", n.src)
                        }
                        return null
                    }
                    return i.checkSrc(n)
                  ...
                  , a = o.length;
                0 !== a ? t.each(o, function(e, o) {
                    var r = t("<img>");
                    r.on("load.cbp error.cbp", function() {
                        t(this).off("load.cbp error.cbp"),
                        0 === --a && n.call(i)
                    }),
                    o.srcset ? (r.attr("sizes", o.sizes),
                    r.attr("srcset", o.srcset)) : r.attr("src", o.src)
                }) : n.call(i)
            })
        },
        checkSrc: function(e) {
            ...
            if ("" === o)
                return null;
            var a = t("<img>");
            n ? (a.attr("sizes", e.sizes || "100vw"),
            a.attr("srcset", n)) : a.attr("src", o);
            var r = a[0];
            return r.complete && r.naturalWidth !== i && 0 !== r.naturalWidth ? null : r
        },
        display: function() {
            var t = this;
            ...
            t.width > 0 && (t.storeData(t.blocks),
        ...
        resizeEvent: function() {
            ...
            o["private"].resize.initEvent({
                ...
                fn: function() {
                    ...
                    e && t.width !== e && (t.width = e,
                    "alignCenter" === t.options.gridAdjustment && (t.wrapper[0].style.maxWidth = ""),
                    t.layoutAndAdjustment(),
        ...
        gridAdjust: function() {
            var e = this;
            "responsive" === e.options.gridAdjustment ? e.responsiveLayout() : (e.blocks.removeAttr("style"),
        ...
        layout: function() {
            ...
            "slider" === e.options.layoutMode ? (e.sliderLayoutReset(),
            e.sliderLayout()) : (e.mosaicLayoutReset(),
            e.mosaicLayout()),
        ...
        responsiveLayout: function() {
            var e = this;
            e.cols = e[t.isArray(e.options.mediaQueries) ? "getColumnsBreakpoints" : "getColumnsAuto"](),
            e.columnWidth = e.columnWidthTruncate((e.width + e.options.gapVertical) / e.cols),
            e.widthAvailable = e.columnWidth * e.cols,
            "mosaic" === e.options.layoutMode && e.getMosaicWidthReference(),
            e.blocks.each(function(n, i) {
                var o, a = t(i).data("cbp"), r = 1;
                "mosaic" === e.options.layoutMode && (r = e.getColsMosaic(a.widthInitial)),
            ...
            e.blocks.each(function(e, i) {
                t.each(t(i).find("img").filter("[width][height]"), function(e, i) {
                    var o = 0;
                    t(i).parentsUntil(".cbp-item").each(function(e, n) {
                        var i = t(n).width();
                        if (i > 0)
                            return o = i,
                            !1
            ...
            e.blocks.each(function(n, i) {
                ...
                o.height = r,
                o.heightAndGap = r + e.options.gapHorizontal
            })
        },
        getMosaicWidthReference: function() {
            ...
            e[0] ? this.mosaicWidthReference = e[0] : this.mosaicWidthReference = this.columnWidth
        },
        getColsMosaic: function(t) {
            if (t === this.width)
                return this.cols;
            var e = t / this.mosaicWidthReference;
            return e = e % 1 >= .79 ? Math.ceil(e) : Math.floor(e),
        ...
        getColumnsBreakpoints: function() {
            var e, n = this, i = n.width;
            return t.each(n.options.mediaQueries, function(t, n) {
                if (i >= n.width)
                    return e = n,
                    !1
            }),
        ...
        resizeMainContainer: function() {
            var e, n = this, a = Math.max(n.freeSpaces.slice(-1)[0].topStart - n.options.gapHorizontal, 0);
            "alignCenter" === n.options.gridAdjustment && (e = 0,
            ...
            a !== n.height ? (n.obj.style.height = a + "px",
            n.height !== i && (o["private"].modernBrowser ? n.$obj.one(o["private"].transitionend, function() {
                n.$obj.trigger("pluginResize.cbp")
            }) : n.$obj.trigger("pluginResize.cbp")),
            n.height = a,
            n.triggerEvent("resizeMainContainer")) : n.triggerEvent("resizeMainContainer")
        },
        ...
        addItems: function(e, n, i) {
            ...
            a.$ul[i](e.addClass("cbp-item-loading").css({
                top: "100%",
                left: 0
            })),
            o["private"].modernBrowser ? e.last().one(o["private"].animationend, function() {
                a.addItemsFinish(e, n)
            }) : a.addItemsFinish(e, n),
            a.loadImages(e, function() {
                if (a.$obj.addClass("cbp-updateItems"),
                "append" === i)
                    a.storeData(e, a.blocks.length),
                    t.merge(a.blocks, e);
                else {
                    a.storeData(e);
                    var n = e.length;
            ...
            e.each(function(e, n) {
                i.blocks.each(function(e, a) {
                    if (n === a) {
                        var r = t(a);
                        i.blocks.splice(e, 1),
                        o["private"].modernBrowser ? (r.one(o["private"].animationend, function() {
                            r.remove()
                        }),
    ...
    t.fn.cubeportfolio = function(t, e, n) {
        return this.each(function() {
            ...
            if (o["public"][t])
                return o["public"][t].call(this, e, n);
...
function(t, e, n, i) {
    ...
    t.extend(o.prototype, {
        ...
        getSpaceIndexAndBlock: function() {
            var e = this
              , n = null;
            return t.each(e.freeSpaces, function(i, o) {
                var a = o.leftEnd - o.leftStart
                  , r = o.topEnd - o.topStart;
                return e.blocksOn.each(function(e, s) {
                    var l = t(s).data("cbp");
                    if (!0 !== l.pack)
                        return l.widthAndGap <= a && l.heightAndGap <= r ? (l.pack = !0,
                        n = {
                            spaceIndex: i,
                            dataBlock: l
                        },
                ...
                !e.blocksAreSorted && e.options.sortByDimension && i > 0 ? (n = null,
                !1) : null === n && void 0
            }),
            n
        },
        generateF1F2: function(t, e) {
            ...
            i.leftEnd > i.leftStart && i.topEnd > i.topStart && (this.freeSpaces.splice(t, 0, i),
            t++),
            o.leftEnd > o.leftStart && o.topEnd > o.topStart && this.freeSpaces.splice(t, 0, o)
        },
        generateG1G2G3G4: function(e) {
            ...
            t.each(n.freeSpaces, function(t, o) {
                ...
                null !== a ? (n.generateG1(o, a, i),
                n.generateG2(o, a, i),
                n.generateG3(o, a, i),
                n.generateG4(o, a, i)) : i.push(o)
            }),
            n.freeSpaces = i
        },
        ...
        addHeightToBlocks: function() {
            ...
            t.each(e.freeSpaces, function(n, i) {
                e.blocksOn.each(function(n, o) {
                    var a = t(o).data("cbp");
                    !0 === a.pack && (e.intersectSpaces(i, a) && -1 === i.topStart - a.topNew - a.heightAndGap && (o.style.height = a.height - 1 + "px"))
                })
            })
        },
        sortBlocks: function(e, n, i, o) {
            ...
            e.sort(function(e, a) {
                var r = t(e).data("cbp")
                  , s = t(a).data("cbp");
                return r[n] > s[n] ? o : r[n] < s[n] ? -o : r[i] > s[i] ? o : r[i] < s[i] ? -o : r.index > s.index ? o : r.index < s.index ? -o : void 0
            })
        }
    })
}(jQuery, window, document),
...
function(t, e, n, i) {
    ...
    o["private"] = {
            ...
            o.scrollEvent = function() {
                ...
                a.on(e, function() {
                    ...
                    r = setTimeout(function() {
                        t.isFunction(i) && i.call(o) || t.each(o.events, function(t, e) {
        ...
        checkInstance: function(e) {
            ...
            if (!n)
                throw new Error("cubeportfolio is not initialized. Initialize it before calling " + e + " method!");
            return n.triggerEvent("publicMethod"),
            n
        },
        browserInfo: function() {
            var t, n, i = o["private"], a = navigator.appVersion;
            -1 !== a.indexOf("MSIE 8.") ? i.browser = "ie8" : -1 !== a.indexOf("MSIE 9.") ? i.browser = "ie9" : -1 !== a.indexOf("MSIE 10.") ? i.browser = "ie10" : e.ActiveXObject || "ActiveXObject"in e ? i.browser = "ie11" : /android/gi.test(a) ? i.browser = "android" : /iphone|ipad|ipod/gi.test(a) ? i.browser = "ios" : /chrome/gi.test(a) ? i.browser = "chrome" : i.browser = "",
            void 0 !== typeof i.styleSupport("perspective") && (t = i.styleSupport("transition"),
            i.transitionend = {
        ...
        styleSupport: function(t) {
            var e, i = "Webkit" + t.charAt(0).toUpperCase() + t.slice(1), o = n.createElement("div");
            return t in o.style ? e = t : i in o.style && (e = i),
            o = null,
            e
        }
    },
    ...
    o["private"].resize = new o["private"].publicEvents("resize.cbp",50,function() {
        if (e.innerHeight == screen.height)
            return !0
    }
    )
}(jQuery, window, document),
function(t, e, n, i) {
    ...
    o["public"] = {
        ...
        filter: function(e, n) {
            var i, a = o["private"].checkInstance.call(this, "filter");
            if (!a.isAnimating) {
                if (a.isAnimating = !0,
                ...
                t.isFunction(e)) {
                    ...
                    if (a.options.filterDeeplinking) {
                        ...
                        a.singlePage && a.singlePage.url && (a.singlePage.url = location.href)
                    }
                    a.defaultFilter = e,
                    i = a.filterConcat(a.defaultFilter)
                }
                a.triggerEvent("filterStart", i),
                a.singlePageInline && a.singlePageInline.isOpen ? a.singlePageInline.close("promise", {
                    callback: function() {
                        a.computeFilter(i)
                    }
                }) : a.computeFilter(i)
        ...
        append: function(e, n) {
            ...
            i.isAnimating || a.length < 1 ? t.isFunction(n) && n.call(i, a) : (i.isAnimating = !0,
        ...
        layout: function(e) {
            ...
            n.isAnimating || n.width <= 0 ? t.isFunction(e) && e.call(n) : ("alignCenter" === n.options.gridAdjustment && (n.wrapper[0].style.maxWidth = ""),
...
function(t, e, n, i) {
    ...
    t.extend(o.prototype, {
        ...
        destroySlider: function() {
            var e = this;
            "slider" === e.options.layoutMode && (e.$obj.removeClass("cbp-mode-slider"),
        ...
        sliderLayout: function() {
            ...
            e.blocksOn.each(function(n, i) {
                ...
                o.topNew = 0,
                e.sliderFreeSpaces.push({
                    topStart: o.heightAndGap
                })
            }),
            e.getFreeSpacesForSlider(),
            e.$ul.width(e.columnWidth * e.blocksOn.length - e.options.gapVertical)
        },
        ...
        updateSliderPosition: function() {
            ...
            o["private"].modernBrowser ? t.$ul[0].style[o["private"].transform] = "translate3d(" + e + "px, 0px, 0)" : t.$ul[0].style.left = e + "px",
            t.getFreeSpacesForSlider(),
            t.resizeMainContainer()
        },
        dragSlider: function() {
            var a, r, s, l, p, c = this, u = t(n), d = !1, f = {}, g = !1;
            function h(t) {
                c.$obj.removeClass("cbp-mode-slider-dragStart"),
                d = !0,
                0 !== r ? (s.one("click.cbp", function(t) {
                    return !1
                }),
                requestAnimationFrame(function() {
            ...
            function b(t) {
                ...
                c.isDrag = !0;
                var e = l - r;
                r < 0 && r < l ? e = (l - r) / 5 : r > 0 && l - r < -p && (e = (p + l - r) / 5 - p),
                o["private"].modernBrowser ? c.$ul[0].style[o["private"].transform] = "translate3d(" + e + "px, 0px, 0)" : c.$ul[0].style.left = e + "px"
            }
            function v() {
                if (d = !1,
                c.isDrag = !1,
            ...
            function m(t) {
                return t.originalEvent !== i && t.originalEvent.touches !== i && (t = t.originalEvent.touches[0]),
                {
                    x: t.pageX,
                    y: t.pageY
                }
            ...
            c.isDrag = !1,
            "ontouchstart"in e || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0 ? (f = {
            ...
            c.$ul.on(f.start, function(e) {
                c.sliderItemsLength() || (g ? e : e.preventDefault(),
                c.options.auto && c.stopSliderAuto(),
                d ? t(s).one("click.cbp", function() {
                    return !1
                }) : (s = t(e.target),
                a = m(e).x,
                r = 0,
...
function() {
    for (var t = 0, e = ["moz", "webkit"], n = 0; n < e.length && !window.requestAnimationFrame; n++)
...
function(t, e, n, i) {
    ...
    a.prototype.filterLayout = function() {
        var e = this;
        function n() {
            e.blocks.removeClass("cbp-item-on2off cbp-item-off2on cbp-item-on2on").each(function(e, n) {
                var i = t(n).data("cbp");
                i.left = i.leftNew,
                i.top = i.topNew,
                n.style.left = i.left + "px",
        ...
        e.blocksOn2On.addClass("cbp-item-on2on").each(function(e, n) {
            var i = t(n).data("cbp");
            n.style[o["private"].transform] = "translate3d(" + (i.leftNew - i.left) + "px, " + (i.topNew - i.top) + "px, 0)"
        }),
        e.blocksOn2Off.addClass("cbp-item-on2off"),
        e.blocksOff2On = e.blocksOn.filter(".cbp-item-off").removeClass("cbp-item-off").addClass("cbp-item-off2on").each(function(e, n) {
            var i = t(n).data("cbp");
            n.style.left = i.leftNew + "px",
            n.style.top = i.topNew + "px"
        }),
        e.blocksOn2Off.length ? e.blocksOn2Off.last().data("cbp").wrapper.one(o["private"].animationend, n) : e.blocksOff2On.length ? e.blocksOff2On.last().data("cbp").wrapper.one(o["private"].animationend, n) : e.blocksOn2On.length ? e.blocksOn2On.last().one(o["private"].transitionend, n) : n(),
        e.resizeMainContainer()
    }
    ,
    ...
    o.plugins.animationClassic = function(e) {
        return !o["private"].modernBrowser || t.inArray(e.options.animationType, ["boxShadow", "fadeOut", "flipBottom", "flipOut", "quicksand", "scaleSides", "skew"]) < 0 ? null : new a(e)
    }
}(jQuery, window, document),
function(t, e, n, i) {
    "use strict";
    ...
    a.prototype.filterLayout = function() {
        ...
        function i() {
            ...
            "sequentially" === e.options.animationType && e.blocksOn.each(function(e, n) {
        ...
        requestAnimationFrame(function() {
            ...
            e.blocksOn.removeClass("cbp-item-off").each(function(n, i) {
                ...
                "sequentially" === e.options.animationType && (a.wrapper[0].style[o["private"].animationDelay] = 60 * n + "ms")
            }),
            e.blocksOn.length ? e.blocksOn.last().data("cbp").wrapper.one(o["private"].animationend, i) : e.blocksOnInitial.length ? e.blocksOnInitial.last().data("cbp").wrapper.one(o["private"].animationend, i) : i(),
            e.resizeMainContainer()
        })
    }
    ,
    ...
    o.plugins.animationClone = function(e) {
        return !o["private"].modernBrowser || t.inArray(e.options.animationType, ["fadeOutTop", "slideLeft", "sequentially"]) < 0 ? null : new a(e)
    }
}(jQuery, window, document),
function(t, e, n, i) {
    "use strict";
    ...
    a.prototype.filterLayout = function() {
        ...
        requestAnimationFrame(function() {
            ...
            e.blocksOn.removeClass("cbp-item-off").each(function(e, n) {
                ...
                n.style.left = i.left + "px",
                n.style.top = i.top + "px",
                i.wrapper[0].style[o["private"].animationDelay] = 50 * e + "ms"
            });
            var n = e.blocksOn.length
              , r = i.length;
            0 === n && 0 === r ? a() : n < r ? i.last().children(".cbp-item-wrapper").one(o["private"].animationend, a) : e.blocksOn.last().data("cbp").wrapper.one(o["private"].animationend, a),
            e.resizeMainContainer()
        })
    }
    ,
    ...
    o.plugins.animationCloneDelay = function(e) {
        return !o["private"].modernBrowser || t.inArray(e.options.animationType, ["3dflip", "flipOutDelay", "foldLeft", "frontRow", "rotateRoom", "rotateSides", "scaleDown", "slideDelay", "unfold"]) < 0 ? null : new a(e)
    }
}(jQuery, window, document),
function(t, e, n, i) {
    "use strict";
    ...
    a.prototype.filterLayout = function() {
        ...
        requestAnimationFrame(function() {
            ...
            e.blocksOn.length ? e.$ul.one(o["private"].animationend, i) : e.blocksOnInitial.length ? t(n).one(o["private"].animationend, i) : i(),
            e.resizeMainContainer()
        })
    }
    ,
    ...
    o.plugins.animationWrapper = function(e) {
        return !o["private"].modernBrowser || t.inArray(e.options.animationType, ["bounceBottom", "bounceLeft", "bounceTop", "moveLeft"]) < 0 ? null : new a(e)
    }
}(jQuery, window, document),
function(t, e, n, i) {
    "use strict";
...
function(t, e, n, i) {
    ...
    function a(e) {
        this.parent = e,
        e.registerEvent("initFinish", function() {
            e.$obj.on("click.cbp", ".cbp-caption-defaultWrap", function(n) {
                ...
                !e.isAnimating) {
                    ...
                    if (e.$obj.addClass("cbp-caption-expand-active"),
                    ...
                    e.$obj.one("pluginResize.cbp", function() {
                        ...
                        0 === r.height && (a.removeClass("cbp-caption-expand-open"),
                        o.attr("style", ""))
                    }),
...
function(t, e, n, i) {
    ...
    o.plugins.displayBottomToTop = function(e) {
        return o["private"].modernBrowser && "bottomToTop" === e.options.displayType && 0 !== e.blocksOn.length ? new function(e) {
            e.registerEvent("initEndWrite", function() {
                if (!(e.width <= 0)) {
                    var n = t.Deferred();
                    e.pushQueue("delayFrame", n),
                    e.blocksOn.each(function(t, n) {
                        n.style[o["private"].animationDelay] = t * e.options.displayTypeSpeed + "ms"
                    }),
                    e.$obj.addClass("cbp-displayType-bottomToTop"),
                    e.blocksOn.last().one(o["private"].animationend, function() {
...
function(t, e, n, i) {
    ...
    o.plugins.displayFadeIn = function(e) {
        return !o["private"].modernBrowser || "lazyLoading" !== e.options.displayType && "fadeIn" !== e.options.displayType || 0 === e.blocksOn.length ? null : new function(e) {
            e.registerEvent("initEndWrite", function() {
                if (!(e.width <= 0)) {
                    var n = t.Deferred();
                    e.pushQueue("delayFrame", n),
...
function(t, e, n, i) {
    ...
    o.plugins.displayFadeInToTop = function(e) {
        return o["private"].modernBrowser && "fadeInToTop" === e.options.displayType && 0 !== e.blocksOn.length ? new function(e) {
            e.registerEvent("initEndWrite", function() {
                if (!(e.width <= 0)) {
                    var n = t.Deferred();
                    e.pushQueue("delayFrame", n),
...
function(t, e, n, i) {
    ...
    o.plugins.displaySequentially = function(e) {
        return o["private"].modernBrowser && "sequentially" === e.options.displayType && 0 !== e.blocksOn.length ? new function(e) {
            e.registerEvent("initEndWrite", function() {
                if (!(e.width <= 0)) {
                    var n = t.Deferred();
                    e.pushQueue("delayFrame", n),
...
function(t, e, n, i) {
        ...
        e.registerEvent("resetFiltersVisual", function() {
            ...
            n.filters.each(function(e, n) {
                ...
                t.each(i, function(t, e) {
                    ...
                    if (n.length)
                        return n.addClass("cbp-filter-item-active").siblings().removeClass("cbp-filter-item-active"),
                        i.splice(t, 1),
                        !1
                })
            }),
    ...
    a.prototype.registerFilter = function() {
        ...
        e.filters.each(function(o, a) {
            var r = t(a)
              ...
              , p = {};
            r.hasClass("cbp-l-filters-dropdown") && (p.wrap = r.find(".cbp-l-filters-dropdownWrap"),
    ...
    a.prototype.filtersCallback = function(e, n) {
        t.isEmptyObject(e) || (e.wrap.trigger("mouseleave.cbp"),
        e.headerText ? e.headerText = "" : e.header.html(n.html())),
        n.addClass("cbp-filter-item-active").siblings().removeClass("cbp-filter-item-active")
    }
    ,
...
function(t, e, n, i) {
    "use strict";
    t.fn.cubeportfolio.constructor.plugins.changeGapOnMediaQueries = function(e) {
        return new function(e) {
            var n = e.options.gapVertical
              , i = e.options.gapHorizontal;
            e.registerEvent("onMediaQueries", function(o) {
                e.options.gapVertical = o && o.hasOwnProperty("gapVertical") ? o.gapVertical : n,
                e.options.gapHorizontal = o && o.hasOwnProperty("gapHorizontal") ? o.gapHorizontal : i,
                e.blocks.each(function(n, i) {
                    var o = t(i).data("cbp");
...
function(t, e, n, i) {
    ...
    r.prototype.runInit = function() {
        var e = this;
        e.parent.$obj.find(".cbp-slider-inline").not(".cbp-slider-inline-ready").each(function(n, i) {
            var o = t(i)
              , a = o.find(".cbp-slider-item--active").find("img")[0];
            a.hasAttribute("data-cbp-src") ? e.parent.$obj.on("lazyLoad.cbp", function(t, e) {
                e.src === a.src && new s(o)
            }) : new s(o)
        })
    }
...
function(t, e, n, i) {
    ...
    s.prototype.loadImages = function() {
        ...
        0 !== n.length && (e.screenHeight = r.height(),
        n.each(function(n, i) {
            var o = t(i.parentNode);
            if (e.isElementInScreen(i)) {
                var a = i.getAttribute("data-cbp-src");
                null === e.parent.checkSrc(t("<img>").attr("src", a)) ? (e.removeLazyLoad(i, a),
                o.removeClass(e.options.loadingClass)) : (o.addClass(e.options.loadingClass),
    ...
    s.prototype.removeLazyLoad = function(e, n, i) {
        ...
        i && (a["private"].modernBrowser ? t(e).one(a["private"].transitionend, function() {
...
function(t, e, n, i) {
    ...
    function r(e) {
        ...
        e.registerEvent("filterStart", function(t) {
            n.populateItems().then(function() {
                ...
                e > 0 ? (n.loadMore.removeClass("cbp-l-loadMore-stop"),
                n.loadItems.html(e)) : n.loadMore.addClass("cbp-l-loadMore-stop")
            })
        }),
        n[n.options.action]())
    }
    r.prototype.populateItems = function() {
        var e = this;
        return e.items ? t.Deferred().resolve() : (e.items = t(),
        t.ajax({
            url: e.loadMore.attr("href"),
            type: "GET",
            dataType: "HTML"
        }).done(function(n) {
            var i = t.map(n.split(/\r?\n/), function(e, n) {
                return t.trim(e)
            }).join("");
            0 !== i.length && t.each(t.parseHTML(i), function(n, i) {
                t(i).hasClass("cbp-item") ? e.items = e.items.add(i) : t.each(i.children, function(n, i) {
    ...
    r.prototype.populateInsertItems = function(e) {
        ...
        n.items.each(function(e, r) {
            if (a === n.options.loadItems)
                return !1;
            o && "*" !== o ? t(r).filter(o).length && (i.push(r),
            n.items[e] = null,
            a++) : (i.push(r),
            n.items[e] = null,
            a++)
        ...
        0 !== i.length ? n.parent.$obj.cubeportfolio("append", i, e) : n.loadMore.removeClass("cbp-l-loadMore-loading").addClass("cbp-l-loadMore-stop")
    }
    ,
    ...
    r.prototype.auto = function() {
        var n = this
          ...
          , o = !1;
        function r() {
            o || n.loadMore.hasClass("cbp-l-loadMore-stop") || (n.loadMore.offset().top - 200 > i.scrollTop() + i.height() || (o = !0,
            n.populateItems().then(function() {
        ...
        function s() {
            ...
            0 === (t = e && "*" !== e ? n.items.filter(e).length : n.items.length) ? n.loadMore.removeClass("cbp-l-loadMore-loading").addClass("cbp-l-loadMore-stop") : (n.loadItems.html(t),
            i.trigger("scroll.loadMore")),
            o = !1,
            0 === n.items.length && (a["private"].loadMoreScroll.destroyEvent(n),
...
function(t, e, n, i) {
    ...
    var o = t.fn.cubeportfolio.constructor
      ...
      , r = {
        init: function(e, i) {
            var o, r = this;
            if (r.cubeportfolio = e,
            r.type = i,
            r.isOpen = !1,
            r.options = r.cubeportfolio.options,
            "lightbox" === i && (r.cubeportfolio.registerEvent("resizeWindow", function() {
                r.resizeImage()
            }),
            r.localOptions = t.extend({}, a, r.cubeportfolio.options.plugins.lightbox)),
            "singlePageInline" !== i) {
                if (r.createMarkup(),
                "singlePage" === i) {
                    if (r.cubeportfolio.registerEvent("resizeWindow", function() {
                        if (r.options.singlePageStickyNavigation) {
                            var t = r.contentWrap[0].clientWidth;
                            t > 0 && (r.navigationWrap.width(t),
                            r.navigation.width(t))
                        }
                    }),
                    r.options.singlePageDeeplinking) {
                        ...
                        if (t.each(u, function(e, n) {
                            if (r.cubeportfolio.blocksOn.each(function(e, i) {
                                var a = t(i).find(r.options.singlePageDelegate + '[href="' + n + '"]');
                                if (a.length)
                                    return o = a,
                                    !1
                            }),
                        ...
                        o) {
                            ...
                            var s = o
                              ...
                              , p = [];
                            l ? p = s.closest(t(".cbp-item")).find('[data-cbp-singlePage="' + l + '"]') : r.cubeportfolio.blocksOn.each(function(e, n) {
                                var i = t(n);
                                i.not(".cbp-item-off") && i.find(r.options.singlePageDelegate).each(function(e, n) {
                            ...
                            c.setAttribute("href", u[0]),
                            r.openSinglePage([c], c)
                        }
                    }
                    r.localOptions = t.extend({}, a, r.cubeportfolio.options.plugins.singlePage)
                }
            } else {
                if (r.height = 0,
                ...
                r.options.singlePageInlineDeeplinking) {
                    r.url = location.href,
                    "#" === r.url.slice(-1) && (r.url = r.url.slice(0, -1));
                    var u, d = (u = r.url.split("#cbpi=")).shift();
                    t.each(u, function(e, n) {
                        if (r.cubeportfolio.blocksOn.each(function(e, i) {
                            var a = t(i).find(r.options.singlePageInlineDelegate + '[href="' + n + '"]');
                            if (a.length)
                                return o = a,
                                !1
                        }),
                ...
                r.localOptions = t.extend({}, a, r.cubeportfolio.options.plugins.singlePageInline)
            }
        },
        createMarkup: function() {
            var i = this
              , a = "";
            if ("singlePage" === i.type && "left" !== i.options.singlePageAnimation && (a = " cbp-popup-singlePage-" + i.options.singlePageAnimation),
            i.wrap = t("<div/>", {
            ...
            "singlePage" === i.type ? (i.contentWrap = t("<div/>", {
                "class": "cbp-popup-content-wrap"
            }).appendTo(i.wrap),
            "ios" === o["private"].browser && i.contentWrap.css("overflow", "auto"),
            i.content = t("<div/>", {
                "class": "cbp-popup-content"
            }).appendTo(i.contentWrap)) : i.content = t("<div/>", {
                "class": "cbp-popup-content"
            }).appendTo(i.wrap),
            t("<div/>", {
                "class": "cbp-popup-loadingBox"
            }).appendTo(i.wrap),
            "ie8" === o["private"].browser && (i.bg = t("<div/>", {
                "class": "cbp-popup-ie8bg",
                "data-action": "lightbox" === i.type ? "close" : ""
            }).appendTo(i.wrap)),
            "singlePage" === i.type && !1 === i.options.singlePageStickyNavigation ? i.navigationWrap = t("<div/>", {
                "class": "cbp-popup-navigation-wrap"
            }).appendTo(i.contentWrap) : i.navigationWrap = t("<div/>", {
                "class": "cbp-popup-navigation-wrap"
            }).appendTo(i.wrap),
            i.navigation = t("<div/>", {
            ...
            "singlePage" === i.type) {
                i.options.singlePageCounter && (i.counter = t(i.options.singlePageCounter).appendTo(i.navigation),
                i.counter.text("")),
                i.content.on("click.cbp", i.options.singlePageDelegate, function(t) {
                    t.preventDefault();
                    var e, o, a = i.dataArray.length, r = this.getAttribute("href");
                    for (e = 0; e < a; e++)
                    ...
                    if (void 0 === o) {
                        ...
                        i.singlePageJumpTo(o - i.current)
                });
                var r = !1;
                try {
                ...
                i.contentWrap[0].addEventListener(p, function(t) {
                    t.stopImmediatePropagation()
                }, r)
            }
            t(n).on("keydown.cbp", function(t) {
                i.isOpen && (i.stopEvents || (l && t.stopImmediatePropagation(),
                37 === t.keyCode ? i.prev() : 39 === t.keyCode ? i.next() : 27 === t.keyCode && i.close()))
            })
        },
        ...
        destroy: function() {
            ...
            e.cubeportfolio.$obj.off("click.cbp", e.options.singlePageInlineDelegate),
            ...
            e.cubeportfolio.$obj.find(".cbp-item").removeClass("cbp-singlePageInline-active"),
            e.wrap.remove()
        },
        openLightbox: function(i, o) {
            var a, r, s = this, p = 0, c = [];
            if (!s.isOpen) {
                if (l = !0,
                s.isOpen = !0,
                s.stopEvents = !1,
                ...
                t.each(i, function(e, n) {
                    var i, o = n.getAttribute("href"), r = o, l = "isImage";
                    if (-1 === t.inArray(o, c)) {
                        if (a === o)
                            s.current = p;
                        ...
                        if (/youtu\.?be/i.test(o)) {
                            ...
                            r = "//www.youtube.com/embed/" + (i = i.replace(/\?|&/, "?")),
                            l = "isYoutube"
                        } else
                            /vimeo\.com/i.test(o) ? (i = o.substring(o.lastIndexOf("/") + 1),
                            /autoplay=/i.test(i) || (i += "&autoplay=1"),
                            r = "//player.vimeo.com/video/" + (i = i.replace(/\?|&/, "?")),
                            l = "isVimeo") : /www\.ted\.com/i.test(o) ? (r = "http://embed.ted.com/talks/" + o.substring(o.lastIndexOf("/") + 1) + ".html",
                            l = "isTed") : /soundcloud\.com/i.test(o) ? (r = o,
                            l = "isSoundCloud") : /(\.mp4)|(\.ogg)|(\.ogv)|(\.webm)/i.test(o) ? (r = -1 !== o.indexOf("|") ? o.split("|") : o.split("%7C"),
                            l = "isSelfHostedVideo") : /\.mp3$/i.test(o) && (r = o,
                            l = "isSelfHostedAudio");
                        s.dataArray.push({
                            src: r,
                ...
                1 === s.counterTotal ? (s.nextButton.hide(),
                s.prevButton.hide(),
                s.dataActionImg = "") : (s.nextButton.show(),
                s.prevButton.show(),
        ...
        openSinglePage: function(i, a) {
            var r, s = this, l = 0, p = [];
            if (!s.isOpen) {
                if (s.cubeportfolio.singlePageInline && s.cubeportfolio.singlePageInline.isOpen && s.cubeportfolio.singlePageInline.close(),
                s.isOpen = !0,
                s.stopEvents = !1,
                s.dataArray = [],
                s.current = null,
                ...
                if (t.each(i, function(e, n) {
                    ...
                    -1 === t.inArray(i, p) && (r === i && (s.current = l),
                    s.dataArray.push({
                        url: i,
                        element: n
                    }),
                ...
                s.counterTotal = s.dataArray.length,
                1 === s.counterTotal ? (s.nextButton.hide(),
                s.prevButton.hide()) : (s.nextButton.show(),
                s.prevButton.show()),
                s.wrap.appendTo(n.body),
                s.scrollTop = t(e).scrollTop(),
                ...
                s.wrap.one(o["private"].transitionend, function() {
                    ...
                    s.wrap.addClass("cbp-popup-transitionend"),
                    s.options.singlePageStickyNavigation && (s.wrap.addClass("cbp-popup-singlePage-sticky"),
                    s.navigationWrap.width(s.contentWrap[0].clientWidth)),
                    s.finishOpen--,
                    s.finishOpen <= 0 && s.updateSinglePageIsOpen.call(s)
                }),
                "ie8" !== o["private"].browser && "ie9" !== o["private"].browser || (t("html").css({
                    overflow: "hidden",
                    marginRight: e.innerWidth - t(n).width()
                }),
                s.wrap.addClass("cbp-popup-transitionend"),
                s.options.singlePageStickyNavigation && (s.navigationWrap.width(s.contentWrap[0].clientWidth),
                setTimeout(function() {
                ...
                s.options.singlePageDeeplinking && (s.url = s.url.split("#cbp=")[0],
                location.href = s.url + "#cbp=" + s.dataArray[s.current].url),
                t.isFunction(s.options.singlePageCallback) && s.options.singlePageCallback.call(s, s.dataArray[s.current].url, s.dataArray[s.current].element),
        ...
        openSinglePageInline: function(n, i, o) {
            ...
            l.isOpen)
                return r = l.cubeportfolio.blocksOn.index(t(i).closest(".cbp-item")),
                void (l.dataArray[l.current].url !== i.getAttribute("href") || l.current !== r ? l.cubeportfolio.singlePageInline.close("open", {
                    blocks: n,
                    currentBlock: i,
                    fromOpen: !0
                }) : l.close());
            ...
            t(l.dataArray[l.current].element).parents(".cbp-item").addClass("cbp-singlePageInline-active"),
            ...
            "top" === l.options.singlePageInlinePosition)
                ...
                n.each(function(e, n) {
                    var i = t(n)
                      , o = i.data("cbp").top
                      , a = o + i.height();
                    a <= u || (o >= u && (l.blocksToMove = l.blocksToMove.add(n)),
                    o < u && a > u && (l.top = a + l.options.gapHorizontal,
                    a - u > l.topDifference && (l.topDifference = a - u + l.options.gapHorizontal)))
                }),
                ...
                n.each(function(e, n) {
                    var i = t(n)
                      ...
                      , a = i.data("cbp").top
                      , r = a + o;
                    r <= c || (a >= c - o / 2 ? l.blocksToMove = l.blocksToMove.add(n) : r > c && a < c && (r > l.top && (l.top = r),
            ...
            l.options.singlePageInlineInFocus) {
                ...
                l.scrollTop !== d ? t("html,body").animate({
                    scrollTop: d
            ...
            t.isFunction(l.options.singlePageInlineCallback) && l.options.singlePageInlineCallback.call(l, l.dataArray[l.current].url, l.dataArray[l.current].element)
        },
        resizeSinglePageInline: function() {
            var t = this;
            t.height = 0 === t.top || t.top === t.cubeportfolio.height ? t.wrap.outerHeight(!0) : t.wrap.outerHeight(!0) - t.options.gapHorizontal,
            ...
            t.blocksToMove.each(function(e, n) {
                o["private"].modernBrowser ? n.style[o["private"].transform] = "translate3d(0px, " + t.height + "px, 0)" : n.style.marginTop = t.height + "px"
            }),
        ...
        updateSinglePage: function(e, n, i) {
            ...
            !1 === i && a.content.removeClass("cbp-popup-content").addClass("cbp-popup-content-basic"),
            a.counter && (o = t(a.getCounterMarkup(a.options.singlePageCounter, a.current + 1, a.counterTotal)),
        ...
        createTwitterShare: function(t) {
            t.length && !t.attr("onclick") && t.attr("onclick", "window.open('https://twitter.com/intent/tweet?source=" + encodeURIComponent(e.location.href) + "&text=" + encodeURIComponent(n.title) + "', '_blank', 'top=100,left=100,toolbar=0,status=0,width=620,height=300'); return false;")
        },
        ...
        createPinterestShare: function(t) {
            if (t.length && !t.attr("onclick")) {
                ...
                i && (n = i.src),
                t.attr("onclick", "window.open('http://pinterest.com/pin/create/button/?url=" + encodeURIComponent(e.location.href) + "&media=" + n + "', '_blank', 'top=100,left=100,toolbar=0,status=0,width=620,height=400'); return false;")
            }
        },
        ...
        singlePageInlineIsOpen: function() {
            ...
            t.cubeportfolio.loadImages(t.wrap, function() {
                ...
                n.length ? (n.find(".cbp-slider-item").addClass("cbp-item"),
        ...
        isImage: function(e) {
            ...
            new Image;
            n.tooggleLoading(!0),
            n.cubeportfolio.loadImages(t('<div><img src="' + e.src + '"></div>'), function() {
                n.updateImagesMarkup(e.src, e.title, n.getCounterMarkup(n.options.lightboxCounter, n.current + 1, n.counterTotal)),
                n.tooggleLoading(!1)
            })
        },
        isVimeo: function(t) {
        ...
        singlePageJumpTo: function(e) {
            ...
            t.isFunction(n.options.singlePageCallback) && (n.resetWrap(),
            n.contentWrap.scrollTop(0),
            n.wrap.addClass("cbp-popup-loading"),
            n.slider && o["private"].resize.destroyEvent(t.data(n.slider[0], "cubeportfolio")),
        ...
        close: function(n, i) {
            var a = this;
            function r() {
                a.slider && o["private"].resize.destroyEvent(t.data(a.slider[0], "cubeportfolio")),
                a.content.html(""),
                a.wrap.detach(),
                a.cubeportfolio.$obj.removeClass("cbp-popup-singlePageInline-open cbp-popup-singlePageInline-close"),
                a.isOpen = !1,
                "promise" === n && t.isFunction(i.callback) && i.callback.call(a.cubeportfolio)
            }
            function s() {
                var i = t(e).scrollTop();
                a.resetWrap(),
                t(e).scrollTop(i),
                a.options.singlePageInlineInFocus && "promise" !== n ? t("html,body").animate({
                    scrollTop: a.scrollTop
                }, 350).promise().then(function() {
                    r()
                }) : r()
            }
            "singlePageInline" === a.type ? "open" === n ? (a.wrap.removeClass("cbp-popup-singlePageInline-ready"),
            t(a.dataArray[a.current].element).closest(".cbp-item").removeClass("cbp-singlePageInline-active"),
            a.isOpen = !1,
            a.openSinglePageInline(i.blocks, i.currentBlock, i.fromOpen)) : (a.height = 0,
            a.revertResizeSinglePageInline(),
            a.wrap.removeClass("cbp-popup-singlePageInline-ready"),
            a.cubeportfolio.$obj.addClass("cbp-popup-singlePageInline-close"),
            a.cubeportfolio.$obj.find(".cbp-item").removeClass("cbp-singlePageInline-active"),
            o["private"].modernBrowser ? a.wrap.one(o["private"].transitionend, function() {
                s()
            }) : s()) : "singlePage" === a.type ? (a.resetWrap(),
            a.stopScroll = !0,
            a.wrap.removeClass("cbp-popup-ready cbp-popup-transitionend cbp-popup-singlePage-open cbp-popup-singlePage-sticky"),
            t("html").css({
                overflow: "",
                marginRight: "",
                position: ""
            ...
            "ie8" !== o["private"].browser && "ie9" !== o["private"].browser || (a.slider && o["private"].resize.destroyEvent(t.data(a.slider[0], "cubeportfolio")),
            a.content.html(""),
            a.wrap.detach(),
            a.isOpen = !1),
        ...
        resizeImage: function() {
            if (this.isOpen) {
                var n = this.content.find("img")
                  , i = n.parent()
                  , o = t(e).height() - (i.outerHeight(!0) - i.height()) - this.content.find(".cbp-popup-lightbox-bottom").outerHeight(!0);
                n.css("max-height", o + "px")
            }
        },
        preloadNearbyImages: function() {
            for (var t = this, e = [t.getIndex(t.current + 1), t.getIndex(t.current + 2), t.getIndex(t.current + 3), t.getIndex(t.current - 1), t.getIndex(t.current - 2), t.getIndex(t.current - 3)], n = e.length - 1; n >= 0; n--)
    ...
    function s(t) {
        var e = this;
        e.parent = t,
        !1 === t.options.lightboxShowCounter && (t.options.lightboxCounter = ""),
    ...
    s.prototype.run = function() {
        var e = this
          ...
          , o = t(n.body);
        i.lightbox = null,
        i.options.lightboxDelegate && !p && (p = !0,
        ...
        o.on("click.cbp", i.options.lightboxDelegate, function(n) {
            ...
            var o = t(this)
              ...
              , l = [];
            s ? s.blocksOn.each(function(e, n) {
                var o = t(n);
                o.not(".cbp-item-off") && o.find(i.options.lightboxDelegate).each(function(e, n) {
                    a ? t(n).attr("data-cbp-lightbox") === a && l.push(n) : l.push(n)
                })
            }) : l = a ? r.find(i.options.lightboxDelegate + "[data-cbp-lightbox=" + a + "]") : r.find(i.options.lightboxDelegate),
            i.lightbox.openLightbox(l, o[0])
        })),
        i.singlePage = null,
        i.options.singlePageDelegate && !c && (c = !0,
        ...
        o.on("click.cbp", i.options.singlePageDelegate, function(n) {
            ...
            s ? s.blocksOn.each(function(e, n) {
                var o = t(n);
                o.not(".cbp-item-off") && o.find(i.options.singlePageDelegate).each(function(e, n) {
                    a ? t(n).attr("data-cbp-singlePage") === a && l.push(n) : l.push(n)
                })
            }) : l = a ? r.find(i.options.singlePageDelegate + "[data-cbp-singlePage=" + a + "]") : r.find(i.options.singlePageDelegate),
            i.singlePage.openSinglePage(l, o[0])
        })),
        i.singlePageInline = null,
        i.options.singlePageInlineDelegate && (i.singlePageInline = Object.create(r),
        i.singlePageInline.init(i, "singlePageInline"),
        i.$obj.on("click.cbp", i.options.singlePageInlineDelegate, function(e) {
            e.preventDefault();
            var n = t.data(this, "cbp-locked")
              , o = t.data(this, "cbp-locked", +new Date);
            (!n || o - n > 300) && i.singlePageInline.openSinglePageInline(i.blocksOn, this)
        }))
    }
    ,
    s.prototype.detectScope = function(e) {
        var i, o, a;
        return (i = e.closest(".cbp-popup-singlePageInline")).length ? (a = e.closest(".cbp", i[0])).length ? a : i : (o = e.closest(".cbp-popup-singlePage")).length ? (a = e.closest(".cbp", o[0])).length ? a : o : (a = e.closest(".cbp")).length ? a : t(n.body)
    }
    ,
    s.prototype.destroy = function() {
        var e = this.parent;
...
function(t, e, n, i) {
    ...
    function a(e) {
        ...
        n.searchInput.siblings(".cbp-search-icon").on("click.cbp", function(e) {
            e.preventDefault(),
            n.runEvent.call(n, t(this).prev().val(""))
        })
    }
    a.prototype.runEvent = function(e) {
        var n = this
          ...
          , o = e.data("searchData")
          , a = new RegExp(i,"i");
        o.value === i || n.parent.isAnimating || (o.value = i,
        i.length > 0 ? e.attr("value", i) : e.removeAttr("value"),
        n.parent.$obj.cubeportfolio("filter", function(e) {
            var r = e.filter(function(e, n) {
                if (t(n).find(o.el).text().search(a) > -1)
                    return !0
            });
...
function(t, e, n, i) {
    ...
    function r(e) {
        ...
        i.length > 0 && (n.parent.customPagination = i,
    ...
    r.prototype.sliderMarkup = function() {
        ...
        e.options.showPagination && (e.navPagination = t("<div/>", {
            "class": "cbp-nav-pagination"
        }).appendTo(e.nav)),
        (e.controls || e.navPagination) && e.nav.appendTo(e.$obj),
        e.updateSliderPagination(),
        e.options.auto && (e.options.autoPauseOnHover && (e.mouseIsEntered = !1,
        e.$obj.on("mouseenter.cbp", function(t) {
            e.mouseIsEntered = !0,
            e.stopSliderAuto()
...
function(t, e, n, i) {
    ...
    function r(e) {
        ...
        n.element.on("click.cbp", ".cbp-sort-item", function(i) {
            i.preventDefault(),
            n.target = i.target,
            t(n.target).hasClass("cbp-l-dropdown-item--active") || e.isAnimating || (n.processSort(),
    ...
    r.prototype.processSort = function() {
        ...
        var a = e.sortBy.split(":")
          , r = "string"
          , s = 1;
        if ("int" === a[0] ? r = "int" : "float" === a[0] && (r = "float"),
        "desc" === a[1] && (s = -1),
        e.sort) {
            var l = [];
            ...
            l.sort(function(t, e) {
                var n = t.sortText
                  , i = e.sortText;
                return "string" === r && (n = n.toUpperCase(),
                i = i.toUpperCase()),
                n < i ? -s : n > i ? s : 0
            }),
            ...
            var p = [];
            -1 === s && (n.blocks.each(function(e, n) {
        ...
        e.dropdownWrap.trigger("mouseleave.cbp");
        var c = t(e.target)
          , u = t(e.target).parent();
        if (u.hasClass("cbp-l-dropdown-list"))
            e.dropdownHeader.html(c.html()),
            c.addClass("cbp-l-dropdown-item--active").siblings(".cbp-l-dropdown-item").removeClass("cbp-l-dropdown-item--active");
        else if (u.hasClass("cbp-l-direction")) {
            0 === c.index() ? u.addClass("cbp-l-direction--second").removeClass("cbp-l-direction--first") : u.addClass("cbp-l-direction--first").removeClass("cbp-l-direction--second")
        }
    }
    ,
    r.prototype.destroy = function() {
